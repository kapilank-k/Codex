...
import AnimatedCharacter from './components/AnimatedCharacter'; // Ensure import is present
...
function App() {
  ...
  const handleStartGame = () => setShowLandingPage(false);
  ...
  return (
    <main className="bg-[#0F110C] min-h-screen p-8 sm:p-12 font-mono overflow-hidden">
      <div className="container mx-auto h-[calc(100vh-4rem)] sm:h-[calc(100vh-6rem)] relative">
        ...
        {/* THE FIX: The character is now INSIDE the relative container. */}
        {/* This makes it part of the same stacking context as the panels. */}
        <AnimatedCharacter />
